      ...
      >
        ...
        <div className="bg-vault-surface border border-vault-border p-8 md:p-12 transition-colors duration-500">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            >
              {isLoading ? "Initializing..." : "Register Vault Identity"}
            </button>
          </form>
          ...
          <div className="mt-10 text-center space-y-4">
            ...
            <p className="text-[10px] text-vault-text-secondary/50 uppercase tracking-tighter text-wrap">
              Privacy Guaranteed by Institutional Standards
            </p>
          </div>
        </div>
      </motion.div>
